# Installing Smart Flow for Codex

Quick setup to enable Smart Flow in Codex.
...
```
Fetch and follow instructions from https://raw.githubusercontent.com/YOUR-USERNAME/smart-flow/main/.codex/INSTALL.md
```
...
**3. Update ~/.codex/AGENTS.md** to include this Smart Flow section:
...
Test the installation with Codex:
...
```
~/.codex/skills/smart-flow/hooks/bootstrap.sh
```
...
```bash
rm -rf ~/.codex/skills/smart-flow
```

Then remove the Smart Flow section from ~/.codex/AGENTS.md.
